...
impl Theme {
    fn dark() -> Self {
        Self {
            ...
            work_bg: ThemeColor(Color::Rgb(20, 22, 27)),
            work_detail_bg: ThemeColor(Color::Rgb(25, 27, 33)),
            work_output_bg: ThemeColor(Color::Rgb(16, 18, 22)),
            work_hover_bg: ThemeColor(Color::Rgb(30, 33, 40)),
            activity_bg: ThemeColor(Color::Rgb(21, 23, 28)),
    ...
    fn light() -> Self {
        Self {
            ...
            work_bg: ThemeColor(Color::Rgb(246, 247, 249)),
            work_detail_bg: ThemeColor(Color::Rgb(236, 238, 243)),
            work_output_bg: ThemeColor(Color::Rgb(250, 250, 252)),
            work_hover_bg: ThemeColor(Color::Rgb(224, 230, 238)),
            activity_bg: ThemeColor(Color::Rgb(242, 243, 246)),
