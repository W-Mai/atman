...
pub struct Theme {
    ...
    pub note_success_bg: Color,
    pub note_debug_bg: Color,
    pub tinted_fg: Color,
    pub subtle_fg: Color,
    pub modal_bg: Color,
    pub panel_bg: Color,
...
impl Theme {
    fn dark() -> Self {
        Self {
            ...
            note_success_bg: Color::Rgb(18, 32, 22),
            note_debug_bg: Color::Rgb(22, 22, 24),
    ...
    fn light() -> Self {
        Self {
            ...
            note_success_bg: Color::Rgb(210, 240, 210),
            note_debug_bg: Color::Rgb(235, 235, 240),
